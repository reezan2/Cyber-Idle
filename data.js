...
var CFG = {
  ...
  LOOT_CH:0.10, REL_CH:0.05, PIECE_CH:0.07,
...
var MISSION_TYPES = [
  {id:'gems', nm:'Collecte de gemmes', unit:'gemme', rewardCr:250, rewardGems:2},
  {id:'credits', nm:'Flux de crédits', unit:'₵', rewardCr:400, rewardGems:1},
  {id:'kills', nm:'Nettoyage de drones', unit:'kill', rewardCr:300, rewardGems:1},
  {id:'waves', nm:'Progression de run', unit:'vague', rewardCr:350, rewardGems:2},
  {id:'duels', nm:'Dominance duel', unit:'duel', rewardCr:500, rewardGems:3},
];
...
var HEROES = [
  { id:'berserker', name:'CYBER BERSERKER', arch:'OFFENSIF',
    ...
    spells:[
      ...
      {id:'chain',name:'Décharge Chainée', desc:'3 hits 120% ATQ. Duel: 260% ATQ.',                ulv:15,passive:false,type:'multiBurst', pwr:1.2,hits:3,energy:2},
  ...
  { id:'warden', name:'IRON WARDEN', arch:'DÉFENSIF',
    ...
    spells:[
      ...
      {id:'fort', name:'Forteresse',         desc:'Soigne 25% PV. Duel: idem.',                    ulv:1, passive:false,type:'heal',      pwr:0.25,     energy:1},
      {id:'nano', name:"Nanobots d'Urgence",desc:'Bouclier à 100%. Duel: idem.',                   ulv:5, passive:false,type:'shFull',    pwr:1.0,      energy:1},
      {id:'ishll',name:'Carapace de Fer',   desc:'+200 bouclier 4s. Duel: +150.',                  ulv:8, passive:false,type:'shBoost',   pwr:200,dur:4, energy:1},
...
var UPGRADES = [
  {id:'up_force',stat:'atk',  cat:'attaque',   name:'Augmentation Physique',  icon:'⚔️',desc:'+1% de l\'ATQ totale par niveau',  bCost:120,sc:1.55,max:100},
  {id:'up_dex',  stat:'crit', cat:'attaque',   name:'Précision Cybernétique', icon:'🎯',desc:'+0.5% Critique par niveau',     bCost:140,sc:1.55,max:100},
  {id:'up_end',  stat:'hp',   cat:'defense',   name:'Renforcement Cellulaire',icon:'♥', desc:'+1% des PV totaux par niveau',   bCost:130,sc:1.55,max:100},
  {id:'up_int',  stat:'spPwr',cat:'utilitaire',name:'Surcadençage Neural',    icon:'🧠',desc:'+0.5% puissance sorts par niveau',        bCost:160,sc:1.60,max:100},
  {id:'up_agi',  stat:'aspd', cat:'attaque',   name:'Boost de Vitesse',       icon:'⚡',desc:'+1% de la VitAtq totale par niveau',        bCost:140,sc:1.55,max:100},
  {id:'up_res',  stat:'sh',   cat:'defense',   name:'Blindage Quantique',     icon:'◈', desc:'+1% du Bouclier total par niveau',      bCost:130,sc:1.55,max:100},
  {id:'up_cha',  stat:'pros', cat:'utilitaire',name:'Algo. de Chance',        icon:'⭐',desc:'+0.5 Prospérité par niveau',           bCost:120,sc:1.50,max:100},
  {id:'up_per',  stat:'mult', cat:'utilitaire',name:'Optimiseur de Revenus',  icon:'₵', desc:'+0.5% multiplicateur crédits/niveau',       bCost:150,sc:1.60,max:100},
];
